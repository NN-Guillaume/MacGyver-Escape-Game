...
mg = Charac("ressources/MacGyver.png", "ressources/MacGyver.png", "ressources/MacGyver.png", "ressources/MacGyver.png", level)
...
while continuer:
    ...
    level.display(window)
    window.blit(mg.direction, (mg.x, mg.y)) #set the picture in the right direction 
